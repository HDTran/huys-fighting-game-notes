...
The easiest way to get bored in training mode is by using it for only combos and having no goals.
...
This keeps the defensive drill entertaining and doubles you up on training different skills. You can see an example in [[Drive Impact Defense#Ken Expansion with Jinrai Loops]].
...
2. **Encoding the skill for use.** Next, we need to automatically recognize the situations where the skill is useful so that we can apply it. This is an essential period for defensive drills. Familiarity with this phase will eventually lead to in-game use. In Master Rank, we should drill to get to the end of this phase because we're trying to make all of our moves as extensions to ourselves. If we don't, we're better served by shortcutting a little with Modern (and even then, they have different encoding to do at higher ranks). Here, I'm trying to hit the goal of 1,000 good reps even though I often get to using the skill way before I'm done. I'm also trying to encode it with more than just 1 set if possible per week. Maybe I should tweak it down, I'm not sure. You should tune yourself to whatever you feel is a good encoding phase.
3. **Topping off the skill so off so it doesn't get forgotten.** How often should we repeat the drill regularly so that it remains in our toolbox? Some skills we'll use so often in actual battle that we potentially may not need to do this anymore. Figuring out the need (or not) is the beauty of understanding and attuning to ourselves. Eventually, my goal is 10,000 good reps through topping it off and actual use.
...
- **Figure out 2-3 drills I'm encoding for use.** This is where I'm trying to get to 1,000 reps over time. I'm trying to do 1-3 sets of these per week and adding it to the tracker. Currently in encoding:
	...
	- [[Drive Rush Defense Option Select]]. Advanced, stopping people from driving on me too much.
- **Top off with defensive essentials.** I am a player who feels more confident when I get my stops, so I prioritize them accordingly. I'm able to get enough time to do a set of these every week. Sometimes I get a second set. Currently in the rotation:
	- [[Crosscut Uppercuts]]
	- [[Backwalking and Crouching Uppercuts]] (as two different drills)
...
I'm eagerly awaiting for skills I'm encoding to enter top-off stage. Then I can proceed with focusing on more advanced defensive drills or character specific drills (especially Ryu right now).
...
- **Jab Confirm Combo.** Whenever we get a jab, what is the meter-less follow-up?
- **All-Resource/Cash Out Combo.** Whenever we can kill, what is the route to using all of our drive meter and Super Art 3 to finish someone off?
- **Drive Impact Combo.** Whenever we land a drive impact, what combo do we use before your opponent falls over?
- **Long-Range Drive Rush Combo.** When we're battling in neutral and throwing out a medium or heavy button, what combo do we buffer Drive Rush behind and confirm?
- **Oki-Setup Combo.** Do we have a combo where we trade damage to get another chance of keeping our turn and putting them into a mixup? To get a safe-jump?
- **Corner-Carry Combo.** If we need to push our opponent into the corner, do we have a combo that pushes them further than others?

Advanced combos incorporate more factors such as mid-combo resets (usually into a Drive Rush overhead or corner Drive Impact), corner escape, using super arts 1 and 2, drive damage, whether you can kill, safe jump setups, corner-only damage optimizations, and more. As we play our characters longer and the above standard combos get ingrained, we should keep branching out as players.

Asking ourselves what is optimal and valuing the eventual matrix of the different factors between our combos is a part of our own play style and player expression.

...
- TODO: Is Guile crouching for Sonic Booms or standing?
- TODO: PP
- TODO
## Jamie
...
- TODO: double-jumping actually works
- TODO: ideal range is outside of cane pokes and ambiguous AA jump range
- TODO
## Juri
...
- TODO
## Marisa
- Marisa is very weak to anti-air. If you jump with a deep vertical button or an empty jump from far away such that her anti-air cHP will whiff, you can likely get your offense started. Some Marisas are keen on watching out for AA situations more, using air-to-air and other tools. Figure out if the Marisa you're playing is one of those or not and at least force her to know that you might jump by testing it. So the following breakdowns are useful:
	- If Marisa isn't able to stop your jumps, play around with ranges and entries to force her to stress about it.
	- If Marisa is watching for air-to-air, fake jumps by pumping crouch (and returning to neutral) at ideal jump ranges to make her think you're about to jump.
- TODO: to parry or not to parry gladius
- TODO: dealing with Phalanx: watch backwalking, AA with special/OD, AA with long jab for hard knockdown and potentially follow-up
- TODO
## M. Bison
...
- TODO
## Sagat
- TODO: Tiger Nexus--if you're betting on Greedy Tiger follow-up, duck and be prepared for cLP on whiff.
